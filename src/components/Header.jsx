    ...
    return (
        <header className="mt-[40px]">
            <div className="flex justify-end w-[95%]">
                <div onClick={changeLang} className={`flex justify-center items-center pl-[8px] pr-[8px] pt-[7px] rounded-[8px] hover:backdrop-blur-[5px] hover:bg-[#5b5d64]/20 duration-200 ${lang === 'ua' && selected}`}>
                ...
                <div onClick={changeLang} className={`flex justify-center items-center pl-[8px] pr-[8px] pt-[7px] rounded-[8px] hover:backdrop-blur-[5px] hover:bg-[#5b5d64]/20 duration-200 ${lang === 'en' && selected}`}>
